 ...
 */
export function translateNonStreamingResponse(responseBody, targetFormat, sourceFormat, responsesToolState) {
  if (targetFormat === sourceFormat) return responseBody;
  if (targetFormat === FORMATS.OPENAI && sourceFormat === FORMATS.OPENAI_RESPONSES) {
    return openAICompletionToOpenAIResponsesResponse(responseBody, responsesToolState);
  }
 ...
 */
export async function handleNonStreamingResponse({ providerResponse, provider, model, sourceFormat, targetFormat, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, clientRawRequest, onRequestSuccess, reqLogger, toolNameMap, responsesToolState, trackDone, appendLog, pxpipe, reqTag, log }) {
  trackDone();
  ...
  const translatedResponse = needsTranslation(targetFormat, sourceFormat)
    ? translateNonStreamingResponse(responseBody, targetFormat, sourceFormat, responsesToolState)
    : responseBody;
